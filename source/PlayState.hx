...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Hello Noob World!', 0.2], //From 0% to 19%
		['Ur Bad', 0.4], //From 20% to 39%
	...
	public static var isRiffStage:Bool = false;
	...
	// riff stuff
	var riffbg:FlxSprite;
	var riffpixbg:FlxSprite;
...
// the coder can figure it out lol (just a note for it cuz i cant figure it out)

		defaultCamZoom = stageData.defaultZoom;
		isPixelStage = stageData.isPixelStage;
//		isRiffStage = stageData.isRiffStage;
		...
		switch (curStage)
		{
			case 'stage': //Week 1
				...
				case 'riff-day':
				// STAGE CODE
				var riffbg:BGSprite = new BGSprite('riff-day', -600, -200, 0.9, 0.9);
				riffbg.visible = true;
				add(riffbg);
				
				// PIXEL ONE
				var riffpixbg:BGSprite = new BGSprite('riff-day-pixel', -600, -200, 0.9, 0.9); // not going to use this cuz no senpai ref in air rock
				riffpixbg.visible = false;
				add(riffpixbg);
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
			{
				...
				introAssets.set('riff', ['riff/ready', 'riff/set', 'riff/go']);
				...
				if(isPixelStage) {
					...
					if(isRiffStage) {
					introAlts = introAssets.get('riff');
					antialias = false;
				}
...
songSpeed = SONG.speed;
	...
	public function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:String = checkForAchievement(['r1_pass', 'r2_pass', 'r3_pass', 'r4_pass', // im such a dummy why did i not find this eariler.. - rizsim studios
				'r5_pass', 'r6_pass', 'r7_pass', 'r8_pass', 'ur_bad',
	...
	function PixelBG():Void
	{
	riffpixbg.visible = true;
    riffbg.visible = false;
  }
	
	function HDPixelBG():Void
	{
	riffpixbg.visible = false;
    riffbg.visible = true;
  }
	...
	private function checkForAchievement(achievesToCheck:Array<String>):String {
		for (i in 0...achievesToCheck.length) {
			...
			if(!Achievements.isAchievementUnlocked(achievementName)) {
				...
				{
					case 'r1_pass' | 'r2_pass' | 'r3_pass' | 'r4_pass' | 'r5_pass' | 'r6_pass' | 'r7_pass' | 'r8_pass':
						if(isStoryMode && storyPlaylist.length <= 1)
						{
							...
							{
								case 'week1':
									if(achievementName == 'r1_pass') unlock = true; // use r1_pass instead of week1_nomiss
								case 'week2':
									if(achievementName == 'r2_pass') unlock = true;
								case 'week3':
									if(achievementName == 'r3_pass') unlock = true;
								case 'week4':
									if(achievementName == 'r4_pass') unlock = true;
								case 'week5':
									if(achievementName == 'r5_pass') unlock = true;
								case 'week6':
									if(achievementName == 'r6_pass') unlock = true;
								case 'week7':
									if(achievementName == 'r7_pass') unlock = true;
								case 'week8':
								if(achievementName == 'r7_pass') unlock = true;
							}
						}
