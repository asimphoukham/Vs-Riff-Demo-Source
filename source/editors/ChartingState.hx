...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Pixel BG', "ONLY WORKS FOR ROCKER STAGES NOT DEFAULT STAGES Adds Pixel BG"],
		['Remove Pixel BG', "ONLY WORKS FOR ROCKER STAGES NOT DEFAULT STAGES Removes Pixel BG"],
