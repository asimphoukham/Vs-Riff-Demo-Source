...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
		    ['Vs Rocker Crew Team'],
			['The Riff Rocker',		'rocker',		'Musician',					'',	'0xFFae4a59'],
			['Vandinn Celeste',		'vandinn',	'Second Musician',				'https://www.youtube.com/watch?v=dQw4w9WgXcQ',	'0xFF249990'],
			['Amerethefreshboi',	'freshboi',	'Third Musician',	'https://www.youtube.com/watch?v=dQw4w9WgXcQ',	'0xFFf7b209'],
			['Irondog888',			'irondog',	'Charter',				'https://www.youtube.com/watch?v=dQw4w9WgXcQ',		'0xFFb49364'],
			['Rizsim Studios',		'riz',	'Animator & Programmer',	'https://bit.ly/2WIcvHQ',	'0xFFFFDF00'],
			['Feam_pro',			'feam_pro',	'Second Programmer',	'https://www.youtube.com/watch?v=dQw4w9WgXcQ',		'0xFF0454b4'],
			[''],
			['Psych Engine Team'],
