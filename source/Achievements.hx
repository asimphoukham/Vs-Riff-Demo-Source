...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Victory for now...",	"Beat Week 1",				'r1_pass',			false],
		["Goin Haywire",		"Beat Week 2",				'r2_pass',			true],
		["Scientific Research",	"Beat Week 3",				'r3_pass',			true],
		["My Backyard!!!",		"Beat Week 4",				'r4_pass',			true],
		["Concert Test",	"Beat Week 5",				'r5_pass',			true],
		["Stage light for pets",			"Beat Week 6",			'r6_pass',			true],
		["You'll Pay For That...",		"Beat Week 7",				'r7_pass',			 true],
		["You'll Pay For That...",		"Beat Week 8",				'r8_pass',			 true],
